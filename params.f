...
module params
  ...
  real(WP), parameter :: Emin= 0.028_WP, Emax=0.1_WP ! range of Ef
  real(WP), parameter :: B_min=0.01_WP, B_max=0.00001_WP ! range of Btesla
  ...
  character(*) DATFILE
  character(*) DATFILE1
  parameter (DATAFILE='GatE0i028B0i01.dat')
!   parameter (DATAFILE='GatE1i47B0g.dat')
  parameter (DATFILE='LDSxy_E0i028B0i01.dat')
!   parameter (DATFILE='LDSxy_E1i47B0g.dat')
  parameter (DATFILE1='CurTrXY_E0i028B0i01.dat')
!   parameter (DATFILE1='CurXY_E1i47B0TraNeg.dat')
