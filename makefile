...
DASHE = -o #
F90 = ifort
F90FLAGS += -free -openmp -heap-arrays -xSSE4.2 -g -pg
LD = ifort
...
currTransport(SUFOBJ) : params$(SUFOBJ) greenL$(SUFOBJ) greenR$(SUFOBJ) greenTotal$(SUFOBJ) g11lead$(SUFOBJ) potential2d$(SUFOBJ)
